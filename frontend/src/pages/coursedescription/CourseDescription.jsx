...
const CourseDescription = ({ user }) => {
  ...
  const checkoutHandler = async () => {
    ...
    const options = {
      key: "rzp_test_MJpc26dGlfzUME", // Enter the Key ID generated from the Dashboard
      amount: order.id, // Amount is in currency subunits.
      currency: "INR",
      name: "E-Learning", //your business name
      description: "Learn with us",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTdcb_lBqqbKUEYaEhXSUqe8SYZKSM1aoZ3oA&s",
